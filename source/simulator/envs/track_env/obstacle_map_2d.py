...
setting_csv_path = os.path.join(BASE_DIR, 'envs/track_env/track_generator/path.csv')
...
def generate_random_obstacles_track(
    obstacle_map: ObstacleTrackMap,
