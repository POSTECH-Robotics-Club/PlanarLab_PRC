...
Generates interpolated center and boundary paths with heading angles from a CSV track file.
"""
...
from source.simulator.scene.track_generator.utils import plot_arrow
...
def make_csv_paths(csv_file: str, DL=0.1, offset=True) -> tuple[np.ndarray, np.ndarray, np.ndarray]:
    """make_csv_paths
    Input parameters:
